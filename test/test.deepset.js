...
describe( 'deepset cdf', function tests() {
	...
	it( 'should compute the Gumbel cdf and deep set', function test() {
		var data, expected, i;
	...
	it( 'should return an empty array if provided an empty array', function test() {
		assert.deepEqual( cdf( [], mu, beta, 'x' ), [] );
		assert.deepEqual( cdf( [], mu, beta, 'x', '/' ), [] );
	});
